...
export default function MyStack() {
  ...
  async function VerificarLogin() {
    const dados = await AuthService.PegarDadosLogados();

    setUsuarioLogado(dados !== undefined && dados !== null);
    setTipoLogin(dados.Tipo);
  }


  return (
      <View style={styles.container}>
        <View style={usuarioLogado ? styles.app : styles.login}>
          <Stack.Navigator>
            {/* <Stack.Screen
          name="TabBar"
          component={Routes}
...
*/}
        ...
        <Footer exibirTab={usuarioLogado} tipoLogin={tipoLogin}></Footer>
      </View>
