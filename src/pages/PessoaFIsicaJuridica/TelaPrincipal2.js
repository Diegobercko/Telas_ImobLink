      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.perfil}>
            <Pressable style={styles.irPerfil}onPress={()=>{navigation.navigate("Perfil")}}>
                ...
                <View style={styles.dados}>
                  <Text style={styles.nome}>{dados.Tipo == "PJ"? dados.NomeEmpresa : dados.nome}</Text>
          ...
          <View style={styles.portaBotoes}>
            ...
            <Pressable style={styles.poertaBtn} onPress={()=>{navigation.navigate("AcessoMeusImoveis")}}>
              <ImageBackground source={btn1} style={styles.btn}>
                <Text style={styles.btnTxt}>Meus Imoveis</Text>  
              </ImageBackground> 
            </Pressable>

            <Pressable style={styles.poertaBtn} onPress={()=>{navigation.navigate("CadastrarImovel")}}>
              <ImageBackground source={btn2} style={styles.btn}>
                <Text style={styles.btnTxt}>Cadastrar Imoveis</Text>  
              </ImageBackground> 
            </Pressable>

            <Pressable style={styles.poertaBtn} onPress={()=>{navigation.navigate("EditarImovel")}}>
        ...
        <MenuTelaPrincipal 
        func1="CadastrarImovel"
        func2="AcessoMeusImoveis"
        func3="Duvidas"
        func4="Imobilink" />
      </View>
    );
