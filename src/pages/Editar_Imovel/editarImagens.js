...
import { ModelImage } from '../../Components/Modal/image_ampliada'
                            ...
                            <Modal visible={modalIsOpen} animationType="fade" transparent={true}>
                                <TouchableOpacity style={styles.modalOverlay} onPress={handleCloseModal}>
                                    <View style={styles.modalContent}>
                                        <ModelImage />
                                        <TouchableOpacity style={styles.minimizeButton} onPress={handleCloseModal}>
                                            <Text>Minimize</Text>
                                        </TouchableOpacity>
                                    </View>
                                </TouchableOpacity>
